...
const styles = ({ nearform = {}, spacing }) =>
  Object.assign(
    ...
    Object.keys(nearform)
      .map(key => ({
        [key]: { color: nearform[key], borderColor: nearform[key] }
      }))
...
const Theming = ({ classes }) => (
  <Grid container spacing={24}>
    <PageHeading header="Theming" subHeader={SUB_HEADER} moreInfo={MORE_INFO} />
    <Grid item xs={12} sm={12} md={12} lg={12}>
      <Typography variant="title" className={classes.blue} paragraph>
        This text will appear <code>NearForm blue</code> when using the NearForm
        theme
      </Typography>
      <Typography variant="title" className={classes.midnightBlue} paragraph>
        This text will appear <code>midnight blue</code> when using the NearForm
        theme
      </Typography>
      <Typography variant="title" className={classes.supersplit} paragraph>
        This text will appear <code>supersplit</code> when using the NearForm
        theme
      </Typography>
      <Typography variant="title" className={classes.brunchPink} paragraph>
        This text will appear <code>brunch pink</code> when using the NearForm
        theme
      </Typography>
      <Typography variant="title" className={classes.bubblegum} paragraph>
        This text will appear <code>bublegum</code> when using the NearForm
        theme
      </Typography>
